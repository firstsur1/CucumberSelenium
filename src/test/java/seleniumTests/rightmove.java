...
public class rightmove {
	...
	//	driver.get("http://demo.guru99.com/test/facebook.html");
	     driver.findElement(By.id("searchLocation")).sendKeys("newbury park");
	     driver.findElement(By.id("buy")).click();
	    WebElement e= driver.findElement(By.xpath("//*[@id='displayPropertyType']"));
	  //*[@id="displayPropertyType"]
	...
	//    WebElement header = driver.findElement(By.cssSelector("a:contains(\"Sign In\")"));
